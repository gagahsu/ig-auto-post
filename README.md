...
讀信的主旨前綴、套用的模板、跑的時間。每條 pipeline 都發 3 張圖的輪播(carousel)
貼文,不是單圖 — 資料量每天不一樣,塞單張圖字會被擠得很小,拆三張手機上才看得清楚：
...
| 模板(輪播 3 張) | `templates/card_template_1.html` + `_2.html` + `_3.html` | `templates/closing_card_template_1.html` + `_2.html` + `_3.html` |
| 排程(台北) | 08:05 | 22:15 |
...
templates/card_template_2.html           ← 盤前速報輪播第2張:焦點快訊(1080x1350)
templates/card_template_3.html           ← 盤前速報輪播第3張:族群與開盤觀測(1080x1350)
templates/closing_card_template_1.html   ← 盤後統整輪播第1張:指數與籌碼(1080x1350)
templates/closing_card_template_2.html   ← 盤後統整輪播第2張:領漲與弱勢族群(1080x1350)
templates/closing_card_template_3.html   ← 盤後統整輪播第3張:明日觀測(1080x1350)
...
# 打開 output/slide-1.png、output/slide-2.png、output/slide-3.png 看排版對不對
```
